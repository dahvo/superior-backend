...
APPS_DIR = ROOT_DIR / "superiorskip"
env = environ.Env()
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "superiorskip.users.context_processors.allauth_settings",
            ],
        },
    }
]
...
# STATIC
# ------------------------
STATICFILES_STORAGE = "superiorskip.utils.storages.StaticRootGoogleCloudStorage"
...
# MEDIA
# ------------------------------------------------------------------------------
DEFAULT_FILE_STORAGE = "superior_skip.utils.storages.MediaRootGoogleCloudStorage"
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "superiorskip.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
ACCOUNT_FORMS = {"signup": "superiorskip.users.forms.UserSignupForm"}
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "superiorskip.users.adapters.SocialAccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
SOCIALACCOUNT_FORMS = {"signup": "superiorskip.users.forms.UserSocialSignupForm"}
